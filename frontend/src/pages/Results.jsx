...
{!isImageLoaded && 
<div className="flex w-full max-w-xl bg-neutral-500 text-white texxt-sm p-0.5 mt-10 rounded-full">
  <input onChange={e=>setInput(e.target.value)} value={input} type="text" className="flex-1 bg-transparent outline-none ml-8 max-sm:w-20" placeholder='Describe what you want to generate' />
